...
function Build(){
	...
	dotnet.exe publish -f netcoreapp1.0 -c $Configuration --output /learningwsc/chapter4/completed/aspnetcore-iis/musicstore/publishoutput --no-build --runtime win7-x64
	
	dotnet.exe publish-iis -f netcoreapp1.0 -p /learningwsc/chapter4/completed/aspnetcore-iis/musicstore/publishoutput -c $Configuration 
