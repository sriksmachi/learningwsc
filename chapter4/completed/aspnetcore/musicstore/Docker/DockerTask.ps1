...
function Build(){
	...
	dotnet.exe publish --framework netcoreapp1.0 --configuration $Configuration --output /learningwsc/chapter4/completed/aspnetcore/musicstore/publishoutput --no-build
